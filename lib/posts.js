const posts = [
  {
    id: "building-makanak-jo-from-full-stack-app-to-production-deployment",
    title: "Building Makanak Jo: From Full-Stack App to Production Deployment",
    description:
      "How I built Makanak Jo as a production-oriented Jordanian room-sharing platform with Next.js, Express, PostgreSQL, Docker, Cloudflare Tunnel, GitLab CI/CD, R2, and a locked-down VPS.",
    file: "/posts/building-makanak-jo-from-full-stack-app-to-production-deployment.md",
    image: "/images/building-makanak-jo-from-full-stack-app-to-production-deployment.png",
    tags: ["makanak jo", "full stack", "next.js", "express", "postgresql", "postgis", "docker", "cloudflare", "gitlab ci/cd", "devsecops", "infrastructure", "deployment"],
    dateCreated: "July 4, 2026",
    dateModified: "August 17, 2026",
    readingTime: "17 min read",
    featured: true,
  },
  {
    id: "i-replaced-my-routers-bloatware-with-openwrt-and-got-faster-internet",
    title: "I Replaced My Router's Bloatware With OpenWrt and Got Faster Internet",
    description:
      "A non-serial OpenWrt installation journey involving a repacked OEM firmware image, telnet, proper VLANs, better dashboards, and unexpectedly much better latency.",
    file: "/posts/i-replaced-my-routers-bloatware-with-openwrt-and-got-faster-internet.md",
    image: "/images/openwrt-router-firmware-upgrade.png",
    tags: ["openwrt", "router", "networking", "vlans", "wifi", "open source", "firmware", "homelab", "latency", "network security"],
    dateCreated: "September 12, 2026",
    dateModified: "September 12, 2026",
    readingTime: "5 min read",
  },
  {
    id: "building-a-highly-available-dns-resolver-on-aws-with-unbound-auto-scaling-nlb-and-cloudwatch",
    title: "Building a Highly Available DNS Resolver on AWS with Unbound, Auto Scaling, NLB, and CloudWatch",
    description:
      "A highly available AWS DNS resolver project using Unbound, Auto Scaling, a Golden AMI, Network Load Balancing, centralized CloudWatch logging, and DNS traffic analytics.",
    file: "/posts/building-a-highly-available-dns-resolver-on-aws-with-unbound-auto-scaling-nlb-and-cloudwatch.md",
    image: "/images/building-a-highly-available-dns-resolver-on-aws-with-unbound-auto-scaling-nlb-and-cloudwatch.png",
    tags: ["aws", "dns", "unbound", "ec2", "auto scaling", "nlb", "cloudwatch", "observability", "networking", "infrastructure"],
    dateCreated: "May 18, 2026",
    dateModified: "Sep 6, 2026",
  ...
  },
  {
    ...
    tags: ["self-hosting", "homelab", "proxmox", "vps", "privacy", "docker", "linux", "open source", "subscription fatigue", "tinkering", "server", "vpn", "netbird", "tailscale", "hetzner", "oracle", "cloudflare"],
